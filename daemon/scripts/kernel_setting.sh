...
echo 8192 > /proc/sys/net/ipv6/neigh/default/gc_thresh1 
echo 16384 > /proc/sys/net/ipv6/neigh/default/gc_thresh2 
echo 32768 > /proc/sys/net/ipv6/neigh/default/gc_thresh3
